...
class API(Resource):
    ...
    def get(self, project_id: int):
        ...
        fields = (
            ...
            SecurityDependencyTests.name, SecurityDependencyTests.description
        )
        on_clause = and_(SecurityDependencyTests.test_uid == SecurityThresholds.test_uid, 
            SecurityThresholds.project_id == project.id)
        query = db.session.query(*fields).join(SecurityDependencyTests, on_clause)
